...
type SearchClient interface {
	...
	Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*ComicsResponse, error)
	ISearch(ctx context.Context, in *ISearchRequest, opts ...grpc.CallOption) (*ComicsResponse, error)
}
...
func (c *searchClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*ComicsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *searchClient) ISearch(ctx context.Context, in *ISearchRequest, opts ...grpc.CallOption) (*ComicsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ComicsResponse)
...
type SearchServer interface {
	...
	Search(context.Context, *SearchRequest) (*ComicsResponse, error)
	ISearch(context.Context, *ISearchRequest) (*ComicsResponse, error)
...
func (UnimplementedSearchServer) Search(context.Context, *SearchRequest) (*ComicsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Search not implemented")
}
func (UnimplementedSearchServer) ISearch(context.Context, *ISearchRequest) (*ComicsResponse, error) {
...
func _Search_ISearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServer).ISearch(ctx, req.(*ISearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
